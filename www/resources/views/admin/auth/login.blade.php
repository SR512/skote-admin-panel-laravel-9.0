                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="index" class="d-block auth-logo">
                                        <img src="{{asset('assets/images').DIRECTORY_SEPARATOR.config('constants.LOGO_FILE_NAME')}}" alt="" height="18" class="auth-logo-dark">
                                        <img src="{{asset('assets/images').DIRECTORY_SEPARATOR.config('constants.LOGO_FILE_NAME')}}" alt="" height="18" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Sign in to continue to {{config('constants.APP_NAME')}}.</p>
                                    </div>
